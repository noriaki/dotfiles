...
# ----------------------------------------------------------------------------
# mise version management (replaces pyenv)
# ----------------------------------------------------------------------------

alias pyv='mise list python'
alias pyvl='mise list-all python'
alias pyvi='mise install python'
alias pyvg='mise use --global python'
alias pyvlc='mise use python'
...
# isort - Import sorter
# (isort is the command itself)

# flake8 - Linter
alias flake='flake8'

# mypy - Type checker
# (mypy is the command itself)

# pylint - Linter
# (pylint is the command itself)
