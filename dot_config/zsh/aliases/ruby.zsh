...
# ----------------------------------------------------------------------------
# mise version management (replaces rbenv)
# ----------------------------------------------------------------------------

alias rbv='mise list ruby'
alias rbvl='mise list-all ruby'
alias rbvi='mise install ruby'
alias rbvg='mise use --global ruby'
alias rbvlc='mise use ruby'

# ----------------------------------------------------------------------------
# Pry - Enhanced REPL
# ----------------------------------------------------------------------------

# pry is the command itself
